...
In conclusion, the bag of words representation did better in general comparing with the graph of words representation except for the macro-averaging precision. We do not know how to interpret this last remark. Otherwise, we should invetigate in the futur, the effect of a globlal property graph like PageRankf for instance.
